...
public class SystemOperateLog
{
    ...
    {
        return "SystemOperateLog [id=" + id + ", url=" + url + ", targetObject=" + targetObject + ", operateResult="
                + operateResult + ", sessionId=" + sessionId + ", ip=" + ip + ", operateDate=" + operateDate
                + ", userId=" + userId + ", userAgent=" + userAgent + ", acceptLanguage=" + acceptLanguage
                + ", browser=" + browser + ", browserName=" + browserName + ", browserVersion=" + browserVersion
                + ", browserType=" + browserType + ", renderingEngine=" + renderingEngine + ", operatingSystem="
                + operatingSystem + ", systemName=" + systemName + ", deviceType=" + deviceType + "]";
    }
